defmodule InvoiceValidatorTest do
  ...
  test "offset: UTC-8 (Baja California, Tijuana)" do
    ...
    assert {:error, "Invoice was issued more than 72 hrs before received by the PAC"} ==
             InvoiceValidator.validate_dates(emisor_date1, pac_date)

    assert {:error, "Invoice is more than 5 mins ahead in time"} ==
             InvoiceValidator.validate_dates(emisor_date2, pac_date)
  ...
  data = [
    {"72 hrs atrás", "America/Mazatlan", ~N[2022-03-20 13:06:31],
     {:error, "Invoice was issued more than 72 hrs before received by the PAC"}},
    {"72 hrs atrás", "America/Mazatlan", ~N[2022-03-20 14:06:31],
     {:error, "Invoice was issued more than 72 hrs before received by the PAC"}},
    {"72 hrs atrás", "Mexico/General", ~N[2022-03-20 15:06:31], :ok},
    {"72 hrs atrás", "America/Cancun", ~N[2022-03-20 16:06:31], :ok},
    {"72 hrs atrás", "America/Mazatlan", ~N[2022-03-20 13:06:35],
     {:error, "Invoice was issued more than 72 hrs before received by the PAC"}},
    {"72 hrs atrás", "America/Mazatlan", ~N[2022-03-20 14:06:35],
     {:error, "Invoice was issued more than 72 hrs before received by the PAC"}},
    ...
    {"5 mins adelante", "America/Cancun", ~N[2022-03-23 16:11:35],
    ...
    {"5 mins adelante", "Mexico/General", ~N[2022-03-23 15:11:36],
     {:error, "Invoice is more than 5 mins ahead in time"}},
    # ok
    {"5 mins adelante", "America/Cancun", ~N[2022-03-23 16:11:36],
     {:error, "Invoice is more than 5 mins ahead in time"}}
  ]
